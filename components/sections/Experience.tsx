  ...
  const experiences = [
    {
      ...
      description:
        "Led development of scalable MERN applications, mentored junior developers, and optimized application performance by 40%.",
    ...
    },
    {
      ...
      description:
        "Developed and maintained multiple web applications, implemented RESTful APIs, and improved code quality through code reviews.",
    ...
    },
    {
      ...
      description:
        "Built responsive web interfaces using React, collaborated with designers, and contributed to backend development.",
